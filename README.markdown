...
This module manages NGINX configuration. It also enables pagespeed for nginx using a pre-compiled nginx RPM distribution hosted on CTLT server. It allows upstream and vhost resources defined in Hiera.
